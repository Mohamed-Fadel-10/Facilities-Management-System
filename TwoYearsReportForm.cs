...
namespace license
{
    public partial class TwoYearsReportForm : Form
    {
        private readonly Context context;
        private readonly PlaceService placeService;
        public TwoYearsReportForm()
        {
            InitializeComponent();
            context = new Context();
        ...
        private void TwoYearsReportForm_Load(object sender, EventArgs e)
        {
            addreslbl.Text = _Address;
            classificationlbl.Text = _Classification;
            dataGridView1.AutoGenerateColumns = false;
            var query = placeService.SecondReporting(classificationlbl.Text, addreslbl.Text);
