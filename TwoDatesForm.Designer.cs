namespace license
{
    partial class TwoDatesForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TwoDatesForm));
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { Name, Address, Licence_Start_Date, Licence_End_Date, status, Code });
            ...
            dataGridView1.Location = new Point(4, 173);
            ...
            // Start
            // 
            Start.Format = DateTimePickerFormat.Short;
            Start.Location = new Point(913, 35);
            Start.Name = "Start";
            Start.Size = new Size(161, 27);
            Start.TabIndex = 33;
            Start.Value = new DateTime(2023, 12, 26, 0, 0, 0, 0);
            // 
            // End
            // 
            End.Format = DateTimePickerFormat.Short;
            End.Location = new Point(913, 71);
            End.Name = "End";
            End.Size = new Size(161, 27);
            End.TabIndex = 34;
            End.Value = new DateTime(2023, 12, 26, 0, 0, 0, 0);
            // 
            // TwoDatesForm
            // 
            ...
            Text = "تقرير رخصة بين تاريخين";
            Load += TwoDatesForm_Load;
